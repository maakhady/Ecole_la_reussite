    ...
    <div class="row">
        ...
        <div class="col-md-2 sidebar">
            ...
            <div class="d-grid gap-4">
                ...
                <a href="/La_reussite_academy-main/eleves.php"><button class="btn btn-success menu-button active "><i class="fas fa-chalkboard-teacher"></i> Élèves</button></a>
                ...
                <button class="btn  btn-success menu-button"><i class="fas fa-user"></i> Employé</button>          
            ...
            <div class="d-flex justify-content-between align-items-center mb-4 p-3 bg-light">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="logo-container">
                        <img src="/La_reussite_academy-main/assets/img/logo.png?t=<? echo time(); ?>" alt="Logo" class="logo" style="width: 100px;">
                    </div>
          ...
          <div class="row mb-4">
            <div class="col-md-6">
              ...
              <select class="form-select" id="mode_paiement" name="mode_paiement">
                ...
                <option value="Chèque">WAVE</option>
              </select>
            </div>
            <div class="col-md-6">
