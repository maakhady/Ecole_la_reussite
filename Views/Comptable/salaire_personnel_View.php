...
<head>
    ...
    <title>Salaires du Personnel</title>
...
<a href="/La_reussite_academy-main/index.php?action=listSalairesProfesseurs"><button type="button" class="btn btn-success flex-grow-1">EMPLOYES PROFESSEURS</button></a>
                  <a href="#"><button type="button" class="btn link btn-success flex-grow-1">EMPLOYES PERSONNELS</button></a>
<a href="/La_reussite_academy-main/index.php?action=listSalairesEnseignants"><button type="button" class="btn btn-success flex-grow-1">EMPLOYES ENSEIGNANTS</button></a>
            ...
            <div class="bg-white p-4 rounded shadow">
                <h5 class="text-center mb-4">Liste des Salaires du Personnel de l'Ecole</h5>
                    ...
                    <table class="table table-striped">
                        ...
                        <?php if (isset($salaires) && is_array($salaires) && !empty($salaires)): ?>
                            <?php foreach ($salaires as $salaire): ?>
                                <tr>
                                    <td><?= htmlspecialchars($salaire['role']) ?></td>
...
<script>
    ...
    btnEnregistrerSalaire.addEventListener('click', function() {
        ...
        fetch('index.php?action=mettreAJourSalairePersonnel', {
            method: 'POST',
            body: formData
        })
