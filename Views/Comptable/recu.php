...
<div class="print-btn">
    ...
    <button class="retour-btn">
        <a href="escape_comptView.php" style="color: white; text-decoration: none;">Retour</a>
    </button>
</div> 
<!--reçu-->
   ...
   <div class="info">
    <div class="row">
     ...
     <div>
      ...
      <strong>
       ...
       <strong>
    Numéro de reçu:
    <?php echo "RA_R." .isset($_GET['frais_id']) ? htmlspecialchars($_GET['frais_id']) : 'N/A'; ?>
</strong>
    ...
    <div class="row">
     ...
     <strong>
      ...
      <br/>
      Téléphone du tuteur : <?=  (isset($eleve['tel_tuteur']) ? htmlspecialchars($eleve['tel_tuteur']) : '') . '</p>'; ?>
...
<img class="cachet" src="/La_reussite_academy-main/assets/img/LA_réussite.png" alt="Cachet de l'école">
</div>
