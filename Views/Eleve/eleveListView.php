...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/La_reussite_academy-main/assets/css/style.css?t=<? echo time(); ?>">
</head>
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-2 sidebar">
            ...
            <div class="d-grid gap-4">
                    ...
                    <a href="/../La_reussite_academy-main/eleves.php"><button class="btn link btn-success menu-button"><i class="fas fa-chalkboard-teacher"></i> Élèves</button></a>
                ...
                <?php if (is_array($eleves) && count($eleves) > 0) : ?>
                        ...
                        <nav aria-label="Page navigation">
                            <ul class="pagination justify-content-center">
                                <?php if ($page > 1): ?>
                                    <li class="page-item">
                                        <a class="page-link" href="?action=listEleves&page=<?php echo $page - 1; ?>" aria-label="Previous">
                                ...
                                <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                                    <li class="page-item <?php echo ($page == $i) ? 'active' : ''; ?>">
                                        <a class="page-link" href="?action=listEleves&page=<?php echo $i; ?>"><?php echo $i; ?></a>
                                    </li>
                                <?php endfor; ?>

                                <?php if ($page < $totalPages): ?>
                                    <li class="page-item">
                                        <a class="page-link" href="?action=listEleves&page=<?php echo $page + 1; ?>" aria-label="Next">
